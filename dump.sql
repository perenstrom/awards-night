...
--
-- Name: bets; Type: TABLE; Schema: public; Owner: perenstrom
--
...
ALTER TABLE public.bets OWNER TO perenstrom;

--
-- Name: bets_id_seq; Type: SEQUENCE; Schema: public; Owner: perenstrom
--
...
--
-- Name: categories; Type: TABLE; Schema: public; Owner: perenstrom
--
...
ALTER TABLE public.categories OWNER TO perenstrom;

--
-- Name: films; Type: TABLE; Schema: public; Owner: perenstrom
--
...
ALTER TABLE public.films OWNER TO perenstrom;

--
-- Name: groups; Type: TABLE; Schema: public; Owner: perenstrom
--
...
ALTER TABLE public.groups OWNER TO perenstrom;

--
-- Name: groups_id_seq; Type: SEQUENCE; Schema: public; Owner: perenstrom
--
...
--
-- Name: nominations; Type: TABLE; Schema: public; Owner: perenstrom
--
...
ALTER TABLE public.nominations OWNER TO perenstrom;

--
-- Name: nominations_id_seq; Type: SEQUENCE; Schema: public; Owner: perenstrom
--

ALTER TABLE public.nominations ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.nominations_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: players; Type: TABLE; Schema: public; Owner: perenstrom
--
...
ALTER TABLE public.players OWNER TO perenstrom;

--
-- Name: players_id_seq; Type: SEQUENCE; Schema: public; Owner: perenstrom
--
...
--
-- Name: years; Type: TABLE; Schema: public; Owner: perenstrom
--
...
ALTER TABLE public.years OWNER TO perenstrom;

--
-- Name: years_categories; Type: TABLE; Schema: public; Owner: perenstrom
--

CREATE TABLE public.years_categories (
    category_id text NOT NULL,
    year_id integer NOT NULL
);


ALTER TABLE public.years_categories OWNER TO perenstrom;

--
-- Data for Name: bets; Type: TABLE DATA; Schema: public; Owner: perenstrom
--

COPY public.bets (id, nomination, player) FROM stdin;
69	1	1
120	15	1
77	17	1
73	25	1
...
COPY public.nominations (id, year, category, nominee, won, decided, film) FROM stdin;
...
--
-- Name: bets bets_pkey; Type: CONSTRAINT; Schema: public; Owner: perenstrom
--
...
--
-- Name: categories categories_pkey; Type: CONSTRAINT; Schema: public; Owner: perenstrom
--
...
--
-- Name: films films_pkey; Type: CONSTRAINT; Schema: public; Owner: perenstrom
--

ALTER TABLE ONLY public.films
    ADD CONSTRAINT films_pkey PRIMARY KEY (imdb_id);


--
-- Name: groups groups_pkey; Type: CONSTRAINT; Schema: public; Owner: perenstrom
--
...
--
-- Name: nominations nominations_pkey; Type: CONSTRAINT; Schema: public; Owner: perenstrom
--
...
--
-- Name: players players_pkey; Type: CONSTRAINT; Schema: public; Owner: perenstrom
--
...
--
-- Name: years years_pkey; Type: CONSTRAINT; Schema: public; Owner: perenstrom
--
...
--
-- Name: years_categories_category_id_year_id_idx; Type: INDEX; Schema: public; Owner: perenstrom
--

CREATE UNIQUE INDEX years_categories_category_id_year_id_idx ON public.years_categories USING btree (category_id, year_id);


--
-- Name: bets bets_nomination_fkey; Type: FK CONSTRAINT; Schema: public; Owner: perenstrom
--

ALTER TABLE ONLY public.bets
    ADD CONSTRAINT bets_nomination_fkey FOREIGN KEY (nomination) REFERENCES public.nominations(id) ON UPDATE CASCADE;


--
-- Name: bets bets_player_fkey; Type: FK CONSTRAINT; Schema: public; Owner: perenstrom
--

ALTER TABLE ONLY public.bets
    ADD CONSTRAINT bets_player_fkey FOREIGN KEY (player) REFERENCES public.players(id) ON UPDATE CASCADE;


--
-- Name: nominations nominations_category_fkey; Type: FK CONSTRAINT; Schema: public; Owner: perenstrom
--

ALTER TABLE ONLY public.nominations
    ADD CONSTRAINT nominations_category_fkey FOREIGN KEY (category) REFERENCES public.categories(slug) ON UPDATE CASCADE;


--
-- Name: nominations nominations_film_fkey; Type: FK CONSTRAINT; Schema: public; Owner: perenstrom
--

ALTER TABLE ONLY public.nominations
    ADD CONSTRAINT nominations_film_fkey FOREIGN KEY (film) REFERENCES public.films(imdb_id) ON UPDATE CASCADE;


--
-- Name: nominations nominations_year_fkey; Type: FK CONSTRAINT; Schema: public; Owner: perenstrom
--

ALTER TABLE ONLY public.nominations
    ADD CONSTRAINT nominations_year_fkey FOREIGN KEY (year) REFERENCES public.years(year) ON UPDATE CASCADE;


--
-- Name: players players_group_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: perenstrom
--

ALTER TABLE ONLY public.players
    ADD CONSTRAINT players_group_id_fkey FOREIGN KEY (group_id) REFERENCES public.groups(id) ON UPDATE CASCADE;


--
-- Name: years_categories years_categories_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: perenstrom
--

ALTER TABLE ONLY public.years_categories
    ADD CONSTRAINT years_categories_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.categories(slug) ON UPDATE CASCADE;


--
-- Name: years_categories years_categories_year_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: perenstrom
--

ALTER TABLE ONLY public.years_categories
    ADD CONSTRAINT years_categories_year_id_fkey FOREIGN KEY (year_id) REFERENCES public.years(year) ON UPDATE CASCADE;
