...
export type FilmWhereInput = {
  ...
  imdbId?: Prisma.StringFilter<"Film"> | string
...
export type FilmScalarWhereWithAggregatesInput = {
  ...
  imdbId?: Prisma.StringWithAggregatesFilter<"Film"> | string
...
export type FilmOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"imdbId" | "name" | "releaseDate" | "posterUrl", ExtArgs["result"]["film"]>
...
export interface FilmDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const filmWithImdbIdOnly = await prisma.film.findMany({ select: { imdbId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Films and only return the `imdbId`
   * const filmWithImdbIdOnly = await prisma.film.createManyAndReturn({
   *   select: { imdbId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Films and only return the `imdbId`
   * const filmWithImdbIdOnly = await prisma.film.updateManyAndReturn({
   *   select: { imdbId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface FilmFieldRefs {
  readonly imdbId: Prisma.FieldRef<"Film", 'String'>
